...
/* harmony import */ var _logic_icons_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logic/icons.js */ "./src/js/logic/icons.js");
/* harmony import */ var _elements_catcher_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./elements/catcher.js */ "./src/js/elements/catcher.js");
/* harmony import */ var _elements_navbar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./elements/navbar.js */ "./src/js/elements/navbar.js");
/* harmony import */ var _elements_navbar_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_elements_navbar_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _elements_themen_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./elements/themen.js */ "./src/js/elements/themen.js");
/* harmony import */ var _elements_themen_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_elements_themen_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _elements_karte_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./elements/karte.js */ "./src/js/elements/karte.js");
/* harmony import */ var _elements_kandigrid_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./elements/kandigrid.js */ "./src/js/elements/kandigrid.js");
/* harmony import */ var _elements_kandigrid_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_elements_kandigrid_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _elements_cookies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./elements/cookies.js */ "./src/js/elements/cookies.js");
...
if (document.querySelector(".alg-catcher-wrapper")) {
  document.querySelector(".alg-catcher-close").addEventListener("click", function () {
    document.querySelector(".alg-catcher-wrapper").style = "max-height: 0px";
    js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].set("alg-catcher-closed", "true", {
      expires: 2
    });
  });
  document.querySelector(".alg-catcher-content").addEventListener("click", function () {
...
/* harmony import */ var vanilla_cookieconsent_dist_cookieconsent_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vanilla-cookieconsent/dist/cookieconsent.css */ "./node_modules/vanilla-cookieconsent/dist/cookieconsent.css");
/* harmony import */ var _cookie_custom_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cookie-custom.css */ "./src/js/elements/cookie-custom.css");
  ...
  languages: {
    de_inf_norej: {
      consent_modal: {
        ...
        description: "Diese Webseite verwendet essentielle Cookies, welche das optimale Funktionieren der Seite garantieren dein Verhalten auf unserer Webseite aufzeichnen. Letztere werden erst mit deiner Zustimmung gesetzt.",
        primary_btn: {
      ...
      settings_modal: {
        ...
        blocks: [{
          ...
          description: 'Wir verwnden Cookies um deinen Aufenthalt auf der Webseite zu verbessern und dein Verhalten auf unserer Webseite aufzuzeichnen. Du kannst deine Einstellungen jederzeit anpassen. Mehr Informationen zu sensiblen Daten findest du <a href="" class="cc-link">in unseren Datenschutzbestimmungen.</a>'
        }, {
          title: "Erforderliche Cookies",
          description: "Diese Cookies sind erforderlich, damit diese Webseite richtig funktioniert. Ohne sie würde die Seite nicht funktionieren.",
          toggle: {
            value: "necessary",
            enabled: true,
            readonly: true
          ...
          description: "Diese Cookies erlauben es uns, dein Verhalten auf unserer Webseite zu analysieren und zu verfolgen.",
          toggle: {
            value: "analytics",
          ...
          description: 'Für irgendwelche weiteren Fragen betreffend unserer Cookie Verwendungen, <a href="" class="cc-link">kontaktiere uns bitte.</a>'
        }]
      }
    },
    de_inf: {
      consent_modal: {
        title: "Wir verwenden Cookies!",
        description: "Diese Webseite verwendet essentielle Cookies, welche das optimale Funktionieren der Seite garantieren dein Verhalten auf unserer Webseite aufzeichnen. Letztere werden erst mit deiner Zustimmung gesetzt. <button class='cc-link' data-cc='c-settings'>Einstellungen</button>",
        primary_btn: {
          text: "Alle akzeptieren",
          role: "accept_all"
        },
...
function toggleKandiOn(id) {
  var kandiWrapper = document.querySelector(".kandi-wrapper[data-kandi='".concat(id, "']"));
  ...
  var detailsPlaceholder = kandiWrapper.querySelector(".kandi-details-placeholder");
  kandiDetails.style.maxHeight = "".concat(kandiDetailsArrow.offsetHeight, "px");
  detailsPlaceholder.style.maxHeight = "".concat(detailsInner.offsetHeight, "px");
  detailsPlaceholder.style.height = "".concat(detailsInner.offsetHeight, "px");
  setTimeout(function () {
    detailsOuter.style.maxHeight = "".concat(detailsInner.offsetHeight, "px");
  }, 250);
  setTimeout(function () {
    var kandiRect = kandiWrapper.getBoundingClientRect();
    window.scrollTo({
      top: kandiRect.y + window.scrollY - (document.querySelector(".alg-navbar-wrapper").offsetHeight + 18),
      behavior: "smooth"
    });
  }, 500);
}
  ...
  document.querySelectorAll(".kandi-inner").forEach(function (element) {
    element.addEventListener("click", function () {
      if (element.parentElement.classList.contains("kandi-active")) {
        ...
        if (document.querySelector(".alg-gemeinde-intro-wrapper[data-gemeinde]")) {
          var gemeinde = document.querySelector(".alg-gemeinde-intro-wrapper").getAttribute("data-gemeinde");
      ...
      if (document.querySelector(".kandi-wrapper.kandi-active")) {
        toggleKandiOff(document.querySelector(".kandi-wrapper.kandi-active").getAttribute("data-kandi"));
      }
...
window.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".alg-gemeinde-kandi-grid") && window.location.href.includes("?#kandi")) {
    var slug = window.location.href.split("?#kandi=")[1];
    var kandi = document.getElementById(slug).getAttribute("data-kandi");
    toggleKandiOn(kandi);
  }
});
...
"use strict";
var _data_wahlkreise_json__WEBPACK_IMPORTED_MODULE_2___namespace_cache;
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _data_wahlkreise_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/wahlkreise.json */ "./src/js/data/wahlkreise.json");
...
if (document.querySelector(".alg-map-inner")) {
  var wahlkreise = document.querySelectorAll("path.alg-wahlkreis");
  wahlkreise.forEach(function (wahlkreis) {
    (0,tippy_js__WEBPACK_IMPORTED_MODULE_3__["default"])(wahlkreis, {
      content: /*#__PURE__*/ (_data_wahlkreise_json__WEBPACK_IMPORTED_MODULE_2___namespace_cache || (_data_wahlkreise_json__WEBPACK_IMPORTED_MODULE_2___namespace_cache = __webpack_require__.t(_data_wahlkreise_json__WEBPACK_IMPORTED_MODULE_2__, 2)))[wahlkreis.id].name,
      animation: "perspective"
    });
    wahlkreis.addEventListener("click", function () {
      window.location.href = "/gemeinde/".concat(wahlkreis.id);
    });
  });
}
...
if (document.querySelector(".alg-navbar-wrapper")) {
  var NavbarWrapper = document.querySelector(".alg-navbar-wrapper");
...
if (document.querySelector("button.alg-menu-mobile-tofuburger")) {
  var Burger = document.querySelector("button.alg-menu-mobile-tofuburger");
  var Menu = document.querySelector(".alg-navbar-wrapper");
...
changeSlide = function changeSlide() {
  var currentSlide = document.querySelector(".alg-thema-slide-wrapper.alg-thema-slide-active");
  var currentSlideNumber = parseInt(currentSlide.getAttribute("data-slide-id"));
  var nextSlideNumber = currentSlideNumber + 1;

  if (!document.querySelector(".alg-thema-slide-wrapper[data-slide-id='" + nextSlideNumber + "']")) {
    nextSlideNumber = 0;
  }

  var nextSlide = document.querySelector(".alg-thema-slide-wrapper[data-slide-id='" + nextSlideNumber + "']");
  var currentPage = document.querySelector(".alg-thema-page.alg-thema-page-active");
  var nextPage = document.querySelector(".alg-thema-page[data-slide-id='" + nextSlideNumber + "']");
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/tippy.js/animations/perspective.css":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/tippy.js/animations/perspective.css ***!
  \********************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/vanilla-cookieconsent/dist/cookieconsent.css":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/vanilla-cookieconsent/dist/cookieconsent.css ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./src/js/elements/cookie-custom.css":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./src/js/elements/cookie-custom.css ***!
  \*****************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_perspective_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./perspective.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/tippy.js/animations/perspective.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_perspective_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_perspective_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookieconsent_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./cookieconsent.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/vanilla-cookieconsent/dist/cookieconsent.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookieconsent_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookieconsent_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});

/***/ }),

/***/ "./src/js/elements/cookie-custom.css":
/*!*******************************************!*\
  !*** ./src/js/elements/cookie-custom.css ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookie_custom_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./cookie-custom.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./src/js/elements/cookie-custom.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookie_custom_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_cookie_custom_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
"use strict";
module.exports = JSON.parse('{"baar":{"name":"Baar"},"cham":{"name":"Cham"},"huenenberg":{"name":"Hünenberg"},"menzingen":{"name":"Menzingen"},"neuheim":{"name":"Neuheim"},"oberaegeri":{"name":"Oberägeri"},"risch":{"name":"Risch"},"steinhausen":{"name":"Steinhausen"},"unteraegeri":{"name":"Unterägeri"},"walchwil":{"name":"Walchwil"},"zug":{"name":"Zug"}}');
